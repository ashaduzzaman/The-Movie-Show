    ...
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto flex flex-col md:flex-row px-4 py-16">
            {{-- <div class="container mx-0"> --}}
                <img src="{{ $movieDetails['poster_path'] }}" alt="poster" class=" w-64 md:w-96">
            {{-- </div> --}}
            <div class="md:ml-24">
                ...
                @foreach ($movieDetails['cast'] as $cast)
                        <div class="mt-8">
                            <a href="{{ route('peoples.show', $cast['id'])}}">
                                <img src="{{ 'https://image.tmdb.org/t/p/w500/'.$cast['profile_path'] }}" alt="cast_profile" class="hover:opacity-75 transition ease-in-out duration-150">
                            </a>
                            <div class="mt-2">
